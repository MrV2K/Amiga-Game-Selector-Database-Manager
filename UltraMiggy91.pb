...
Procedure Save_IG_DB()
  ...
  If IG_File
    ...
    ForEach UM_Database()
      ...
      WriteStringN(IG_File,UM_Database()\UM_Slave+";"+UM_Database()\UM_Folder+";"+UM_Database()\UM_Genre+";"+UM_Database()\UM_Title+Tags()+";"+UM_Database()\UM_Short+Tags_Short()+";"+UM_Database()\UM_Type)
    Next
  EndIf
...
Procedure Write_Guides(outpath.s,ags.b)
  ...
  ForEach UM_Database()
    ...
    If UM_Database()\UM_Restricted<>#True
      Debug outpath+"WHD-Data\"+UM_Database()\UM_Type+"\"+UM_Database()\UM_Short+Tags_Short()+".guide"
...
Procedure Make_Retroarch_Dat()
  ...
  ForEach UM_Database()
    If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
      ...
      outstring+"        rom ( name "+#DOUBLEQUOTE$+UM_Database()\UM_LHAFile+#DOUBLEQUOTE$+" size "+Str(UM_Database()\UM_FileSize)+" crc "+UCase(UM_Database()\UM_CRC32)+" sha1 "+UM_Database()\UM_SHA1+" )"+#LF$
      outstring+")"+#LF$
    EndIf
  Next
...
Macro Make_AGS_Image(image_path)
  ...
  If make_images
    ...
    If Real Or a500_mini
      If ECS
        path="-quiet -overwrite -out iff -o "+new_file$+" -c 1 -rtype lanczos2 -resize 320 128 -colors 8 -floyd "+source_file$
      Else
        path="-quiet -overwrite -out iff -o "+new_file$+" -c 1 -resize 320 128 -rtype lanczos2 -colors 64 "+source_file$
      EndIf
    Else
      path="-quiet -overwrite -out iff -o "+new_file$+" -c 1 -resize 320 256 -rtype lanczos2 -colors 128 "+source_file$
    EndIf  
    ...
    If Real Or a500_mini
      ...
      Else
        path="-quiet -overwrite -out iff -o "+new_file$+" -c 1 -rtype lanczos2 -ratio -resize 320 256 -canvas 320 256 center -bgcolor 0 0 0 -resize 320 128 -floyd -colors 64 "+source_file$
      EndIf
    Else
...
; CursorPosition = 5615
; FirstLine = 1336
; Folding = AAAACAAAAABAAAAABAAAIAAABAAAAAAAAAw
; Optimizer
; EnableThread
; EnableXP
; DPIAware
