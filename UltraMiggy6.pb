...
Global Game_Info_Path.s=Home_Path+"Game_Data\"
...
Procedure Draw_Info(number)
  ...
  If number<>-1
    ...
    If IsSound(0)
      ...
      FreeSound(0)
    EndIf
    path=Game_Info_Path+UM_Database()\UM_Type+"\"+ReplaceString(UM_Database()\UM_Subfolder,"/","\")+UM_Database()\UM_Folder+"\Music"
...
Procedure Run_CD32(gamenumber.i)
  ...
  If CD32_Database()\CD_Config=0
    output$=" -f "+IG_Path+"CD32.uae -cfgparam cdimage0="+#DOUBLEQUOTE$+CD32_Path+CD32_Database()\CD_File+#DOUBLEQUOTE$+","
  EndIf
  If CD32_Database()\CD_Config=1
    output$=" -f "+IG_Path+"CD32-4MB.uae -cfgparam cdimage0="+#DOUBLEQUOTE$+CD32_Path+CD32_Database()\CD_File+#DOUBLEQUOTE$+","
  EndIf
  If CD32_Database()\CD_Config=2
    output$=" -f "+IG_Path+"CD32-8MB.uae -cfgparam cdimage0="+#DOUBLEQUOTE$+CD32_Path+CD32_Database()\CD_File+#DOUBLEQUOTE$+","
  EndIf
...
Procedure Audit_Archives()
  ...
  If OpenFTP(#FTP,ftp_server,ftp_user,ftp_pass,ftp_passive,ftp_port)
    ...
    ForEach UM_Database()
      If FindMapElement(Comp_Map(),UM_Database()\UM_Type+"\"+ReplaceString(UM_Database()\UM_Subfolder,"/","\")+UM_Database()\UM_LHAFile)=-1
...
Procedure Edit_GL(number) 
  ...
  If OpenWindow(#EDIT_WINDOW, 0, 0, 424, 440, "Edit Database", #PB_Window_SystemMenu | #PB_Window_WindowCentered,WindowID(#MAIN_WINDOW))
    ...
    AddGadgetItem(ConfUM_Combo,-1,"A1200 (Compatible)")
      ...
      Select EventMenu()
        ...
        Case 900 To 1100
          If GetExtensionPart(GetMenuItemText(#POPUP_MENU,EventMenu()))="txt"
            ...
            Text_Viewer(Game_Info_Path+UM_Database()\UM_Type+"\"+ReplaceString(UM_Database()\UM_Subfolder,"/","\")+UM_Database()\UM_Folder+"\"+GetMenuItemText(#POPUP_MENU,EventMenu()))
          EndIf
