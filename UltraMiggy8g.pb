...
Procedure Write_Guides(outpath.s,ags.b)
  ...
  CreateDirectory(Outpath+"Search.ags")
  CreateDirectory(outpath+"Search.ags\WHD-Data")
  CreateDirectory(outpath+"Search.ags\WHD-Data\Game")
  CreateDirectory(outpath+"Search.ags\WHD-Data\Beta")
  CreateDirectory(outpath+"Search.ags\WHD-Data\Magazine")
  CreateDirectory(outpath+"Search.ags\WHD-Data\Demo")
  ...
  ForEach UM_Database()
    ...
    If UM_Database()\UM_Restricted<>#True
      If CreateFile(0,outpath+"Search.ags\WHD-Data\"+UM_Database()\UM_Type+"\"+UM_Database()\UM_Short+Tags_Short()+".guide",#PB_Ascii)
        WriteString(0,"@database"+#LF$)
        WriteString(0,"@wordwrap"+#LF$)
        WriteString(0,""+#LF$)
...
Macro Make_AGS_Image(image_path)
  ...
  If make_images
    ...
    If Real Or a500_mini
      If ECS
        path="-quiet -overwrite -out iff -o "+new_file$+" -c 1 -rtype lanczos2 -resize 320 128 -rtype lanczos -colors 8 -floyd "+source_file$
      Else
...
Procedure Create_AGS_Single()
  ...
  Protected out_folder.s, key$, force_iff.b, set_type.i, Real.b, ECS.b, current_index.i, make_images.b, ans.i, a500_mini.b
  ...
  If AGS_Path<>""  
    ...
    If ReadFile(0,Data_Path+"CPU14.txt")  
      ...
      While Not Eof(0) 
        ...
        EndIf
        CPU14(LCase(path))=LCase(path)
      Wend
      CloseFile(0)
    EndIf
    
    Protected NewMap UAECPU14.s()
    ...
    If ReadFile(0,Data_Path+"UAECPU14.txt")  
      ...
      While Not Eof(0) 
        ...
        EndIf
        UAECPU14(LCase(path))=LCase(path)
      Wend
      CloseFile(0)
    EndIf
    
    Protected NewMap CPU7.s()    
    ...
    If ReadFile(0,Data_Path+"CPU7.txt")  
      ...
      While Not Eof(0) 
        ...
        EndIf
        CPU7(LCase(path))=LCase(path)
      Wend
      CloseFile(0)
    EndIf
    
    Protected NewMap CPU25.s()
    ...
    If ReadFile(0,Data_Path+"CPU25.txt")  
      ...
      While Not Eof(0) 
        ...
        EndIf
        CPU25(LCase(path))=LCase(path)
      Wend
      CloseFile(0)
    EndIf
    
    Protected NewMap FC.s()
    ...
    If ReadFile(0,Data_Path+"ChipsetFC.txt") 
      ...
      While Not Eof(0) 
        ...
        EndIf
        FC(LCase(path))=LCase(path) 
      Wend
      CloseFile(0)
    EndIf
    
    Protected NewMap BW.s()
    ...
    If ReadFile(0,Data_Path+"ChipsetBW.txt") 
      ...
      While Not Eof(0) 
        ...
        EndIf
        BW(LCase(path))=LCase(path) 
      Wend  
      CloseFile(0)
    EndIf
    
    Protected NewMap IB.s()
    ...
    If ReadFile(0,Data_Path+"ChipsetIB.txt") 
      ...
      While Not Eof(0) 
        ...
        EndIf
        IB(LCase(path))=LCase(path)  
      Wend
      CloseFile(0)
    EndIf
    
    Protected NewMap NTSC.s()
    ...
    If ReadFile(0,Data_Path+"NTSC.txt")
      ...
      While Not Eof(0) 
        ...
        EndIf
        NTSC(LCase(path))=LCase(path)
      Wend 
      CloseFile(0)
    EndIf
    
    Protected NewMap NOCYCLE.s()
    ...
    If ReadFile(0,Data_Path+"ChipsetNoCycle.txt")
      ...
      While Not Eof(0) 
        ...
        If Not FindMapElement(Data_Map(),LCase(path))
          AddElement(Missing_List())
          Missing_List()="No Cycle: "+path
        EndIf
        NOCYCLE(LCase(path))=LCase(path)
      Wend 
      CloseFile(0)
    EndIf
    
    Protected NewMap JIT.s()
    ...
    If ReadFile(0,Data_Path+"JIT.txt")
      ...
      While Not Eof(0) 
        ...
        EndIf
        JIT(LCase(path))=LCase(path)
      Wend 
      CloseFile(0)
    EndIf
    
    Protected NewMap VOFFSET.s()
    
    If ReadFile(0,Data_Path+"V_Offset.txt")
      PrintN("Adding Vertical Offset List")
      While Not Eof(0) 
        path=ReadString(0)
        path2=StringField(path,2,Chr(44)) ; Value
        path=StringField(path,1,Chr(44)) ; Name
        path+".info"   
        If Not FindMapElement(Data_Map(),LCase(path))
          AddElement(Missing_List())
          Missing_List()="Vertical Offset: "+Path
        EndIf
        VOFFSET(LCase(path))=LCase(path2)
      Wend 
      CloseFile(0)
    EndIf
    
    Protected NewMap SCREEN200.s()
    ...
    If ReadFile(0,Data_Path+"Screen200.txt") 
      ...
      While Not Eof(0) 
        ...
        EndIf
        SCREEN200(LCase(path))=LCase(path)
      Wend 
      CloseFile(0)
    EndIf
    
    Protected NewMap SCREEN216.s()
    ...
    If ReadFile(0,Data_Path+"Screen216.txt") 
      ...
      While Not Eof(0) 
        ...
        EndIf
        SCREEN216(LCase(path))=LCase(path)
      Wend 
      CloseFile(0)
    EndIf
    
    Protected NewMap SCREEN224.s()
    ...
    If ReadFile(0,Data_Path+"Screen224.txt") 
      ...
      While Not Eof(0) 
        ...
        EndIf
        SCREEN224(LCase(path))=LCase(path)
      Wend 
      CloseFile(0)
    EndIf
   
    Protected NewMap SCREEN232.s()
    ...
    If ReadFile(0,Data_Path+"Screen232.txt") 
      ...
      While Not Eof(0) 
        ...
        EndIf
        SCREEN232(LCase(path))=LCase(path)
      Wend 
      CloseFile(0)
    EndIf
    
    Protected NewMap SCREEN240.s()
    ...
    If ReadFile(0,Data_Path+"Screen240.txt")
      ...
      While Not Eof(0) 
        ...
        EndIf
        SCREEN240(LCase(path))=LCase(path)
      Wend 
      CloseFile(0)
    EndIf
    
    Protected NewMap SCREEN262.s()
    ...
    If ReadFile(0,Data_Path+"Screen262.txt")
      ...
      While Not Eof(0) 
        ...
        EndIf
        SCREEN262(LCase(path))=LCase(path)
      Wend 
      CloseFile(0)
    EndIf
    
    Protected NewMap SCREEN270.s()
    ...
    If ReadFile(0,Data_Path+"Screen270.txt")
      ...
      While Not Eof(0) 
        ...
        EndIf
        SCREEN270(LCase(path))=LCase(path)
      Wend 
      CloseFile(0)
    EndIf
    
    Protected NewMap SCREEN288.s()
    ...
    If ReadFile(0,Data_Path+"Screen288.txt")
      ...
      While Not Eof(0) 
        ...
        EndIf
        SCREEN288(LCase(path))=LCase(path)
      Wend 
      CloseFile(0)
    EndIf
    ...
    ForEach UM_Database()
      ...
      If FindMapElement(CPU14(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_14Mhz=#True
        EndIf
      EndIf
      
      If FindMapElement(UAECPU14(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_UAE_14Mhz=#True
        EndIf 
      EndIf
      
      If FindMapElement(CPU7(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_7Mhz=#True
        EndIf
      EndIf
      
      If FindMapElement(CPU25(),LCase(UM_Database()\UM_Icon))       
        UM_Database()\UM_25Mhz=#True
      EndIf
      
      If FindMapElement(FC(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_FC=#True
        EndIf
      EndIf
      
      If FindMapElement(BW(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_BW=#True
        EndIf
      EndIf
      
      If FindMapElement(IB(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_IB=#True
        EndIf
      EndIf
      
      If FindMapElement(NTSC(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_NT=#True
        EndIf
      EndIf
      
      If FindMapElement(NOCYCLE(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_NoCycle=#True
        EndIf
      EndIf
      
      If FindMapElement(JIT(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_JIT=#True
        EndIf
      EndIf
      
      If FindMapElement(VOFFSET(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_Offset=VOFFSET()
        EndIf
      EndIf
      
      If FindMapElement(SCREEN200(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_VRES=200
        EndIf
      EndIf
      
      If FindMapElement(SCREEN216(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_VRES=216
        EndIf
      EndIf
      
      If FindMapElement(SCREEN224(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_VRES=224
        EndIf
      EndIf
      
      If FindMapElement(SCREEN232(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_VRES=232
        EndIf
      EndIf
      
      If FindMapElement(SCREEN240(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_VRES=240
        EndIf
      EndIf
      
      If FindMapElement(SCREEN262(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          UM_Database()\UM_VRES=262
        EndIf
      EndIf
      
      If FindMapElement(SCREEN270(),LCase(UM_Database()\UM_Icon))
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
    ...
    Make_AGS_Guide(AGS_Path+"Search.ags\WHDLoad_Game_List.guide",#True)
    Make_AGS_Demos_Guide(AGS_Path+"Search.ags\WHDLoad_Demo_List.guide",#True)
    ...
    CreateFile(0,AGS_Path+"Scripts\Random_Game") 
    ForEach UM_Database()
      If UM_Database()\UM_Language="English" And UM_Database()\UM_Adult<>#True
        If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
          path="AGS:+  Games 0-Z.ags/"+UM_Database()\UM_Short+Tags_Short()+".run"
        ElseIf UM_Database()\UM_Type="Demo" Or UM_Database()\UM_Beta_Type="Demo"
          path="AGS:+  Demos 0-Z.ags/"+UM_Database()\UM_Short+Tags_Short()+".run"
        EndIf
...
Procedure Create_AGS_Files()
  ...
  Protected out_folder.s, key$, force_iff.b, set_type.i, Real.b, ECS.b, ans.i, ans2.i, make_images.b, a500_mini.b
  ...
  If AGS_Path<>""
    ...
    ans=MessageRequester("Information","A500 Mini Classic?",#PB_MessageRequester_YesNoCancel|#PB_MessageRequester_Info)
    If ans=#PB_MessageRequester_Yes
      a500_mini=#True
    ElseIf ans=#PB_MessageRequester_No
      a500_mini=#False
...
;   ForEach UM_Database()
;     Debug Right(UM_Database()\UM_Title,1)
;     If Right(UM_Database()\UM_Title,1)=Chr(32)
;       Debug UM_Database()\UM_Title
;     EndIf
;         If Right(UM_Database()\UM_Short,1)=Chr(32)
;       Debug UM_Database()\UM_Title
;     EndIf
;   Next
...
;         CreateFile(0,Home_Path+"Random_Game") 
;       ForEach UM_Database()
;         If UM_Database()\UM_Language="English" And UM_Database()\UM_Adult<>#True
;           If UM_Database()\UM_Type="Game" Or UM_Database()\UM_Beta_Type="Game"
;             path="AGS:+  Games - 0-Z.ags/"+UM_Database()\UM_Subfolder+".ags/"+UM_Database()\UM_Short+Tags_Short()+".run"
...
; CursorPosition = 13548
; FirstLine = 1256
; Folding = AAAAAAAAAAAAAAAAAAAAAAABAAAAAAAAA5
; Optimizer
; EnableThread
; EnableXP
; DPIAware
