...
Procedure Draw_Game_Info(*nul)
  ...
  If GetGadgetState(#MAIN_LIST)<>-1
    ...
    If UM_Database()\UM_ECSOCS=#True
      Add_Output(LSet("Chipset",11," ")+": "+"OCS / ECS"+#CRLF$)
    EndIf
    If UM_Database()\UM_AGA=#True
      Add_Output(LSet("Chipset",11," ")+": "+"AGA"+#CRLF$)
    EndIf
    If UM_Database()\UM_CD32=#True
      Add_Output(LSet("Chipset",11," ")+": "+"AGA/CD32"+#CRLF$)
    EndIf
...
Procedure Restore_DB_Entry()
  ...
  UM_Database()\UM_Slave_Date=Backup_List()\UM_Slave_Date
...
Procedure Save_DB_Entry(entry_path.s)
  ...
  Protected NewList Backup_List.UM_Data()
        ...
        Backup_List()\UM_Slave_Date=UM_Database()\UM_Slave_Date
    ...
    If FTPSetDir(hConnect,FTP_Folder)
      ...
      If ListSize(FTP_Dir_Files())>0
        ...
        ForEach FTP_Dir_Files()
          ...
          If FindString(FileName$,"Commodore Amiga - WHDLoad - Games") Or FindString(FileName$,"Commodore Amiga - WHDLoad - Demos")
...
Procedure Filter_Window()
  ...
  If Not IsWindow(#FILTER_WINDOW)
    ...
    If OpenWindow(#FILTER_WINDOW, x_pos, WindowY(#MAIN_WINDOW)+((WindowHeight(#MAIN_WINDOW)-610)/2), 325, 610, "Filter", #PB_Window_SystemMenu)
...
; CursorPosition = 2294
; FirstLine = 775
; Folding = AMAAAAAABAAAAABCAQAAAAAAAAA-
; Optimizer
; EnableThread
; EnableXP
; EnableUser
